SEED_ROLES: dict[str, list[str]] = {
    ...
    "COORDINADOR": [
        ...
        "coloquios:*", "coloquios:gestionar", "tareas:*", "padron:ver", "padron:importar",
        "atrasados:ver",
...
PERMISO_DESCRIPTIONS: dict[str, str] = {
    ...
    "coloquios:gestionar": "Gestionar coloquios y convocatorias",
    ...
    "comunicaciones:aprobar": "Aprobar comunicaciones",
